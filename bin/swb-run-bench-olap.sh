...
cd $SWB_BIN
./charbench -cs //$TNSHOST/$SERVICE_NAME -c $POCKITDIR/config/${SERVICE_NAME}-olap.xml -r $POCKITDIR/SWB_Results_$DATE/results.xml -dt thin -rt $RUNTIME -uc $USERCOUNT -a -v users,tpm,tps,errs
